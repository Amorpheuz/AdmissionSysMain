...
namespace AdmissionSys.Pages.AcademicRecord.Exams.hsc
{
    ...
    public class hscModel : PageModel
    {
        ...
        public hscModel(AdmissionSys.Models.AdmissionSysContext context, UserManager<NuvAdUser> userManager)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            academicRecordsIQ = academicRecordsIQ.Where(a => a.ExamName.Contains("HSC/Std 12th") && a.StudentID == sturecord.FirstOrDefault().StudentID);
