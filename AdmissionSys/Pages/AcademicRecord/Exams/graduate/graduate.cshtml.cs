...
namespace AdmissionSys.Pages.AcademicRecord.Exams.graduate
{
    [Authorize(Roles = "Applicant,Admin")]
    public class graduateModel : PageModel
    {
            ...
            public graduateModel(AdmissionSys.Models.AdmissionSysContext context, UserManager<NuvAdUser> userManager)
            {
            ...
            public async Task<IActionResult> OnGetAsync()
            {
                ...
                academicRecordsIQ = academicRecordsIQ.Where(a => a.ExamName.Contains("Graduate/Post Graduate") && a.StudentID == sturecord.FirstOrDefault().StudentID);
